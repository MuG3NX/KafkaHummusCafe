...
export function RevenueApp({ onOpenShifts, onOpenInvoices, onOpenCosts }: { onOpenShifts?: () => void; onOpenInvoices?: () => void; onOpenCosts?: () => void }) {
  ...
  const revenueSignal = entry ? `${entry.id}:${entry.version}` : "none";
