...
type ShiftsAppProps = { onOpenRevenue: () => void; onOpenInvoices?: () => void; onOpenCosts?: () => void };
...
export function ShiftsApp({ onOpenRevenue, onOpenInvoices, onOpenCosts }: ShiftsAppProps) {
